...
<title>회원 상세정보</title>
<style>
	#member_detail{border: 1px solid gray;width:70%;height: 450px;margin: 0 auto;border-collapse: collapse;}
	...
	<table id="member_detail">
		<tr>
			<td rowspan="4" style="width:30%">
				<img src="${img}/lee.jpg" alt="W3Schools.com" width="104" height="130">
			</td>
